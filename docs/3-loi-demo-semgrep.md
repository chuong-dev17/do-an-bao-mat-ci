...
- Dòng lỗi:
  ...
  - **Trạng thái:** ⚠️ Đang có lỗi (để Semgrep bắt)
  - **GitHub CI:** ❌ Will FAIL nếu `--strict` được bật
### Vì sao là lỗi
...
- Dòng lỗi:
  - [Dòng 24](../Car_Dealership/src/java/utils/DBUtil.java#L24): `String username = "sa";`
  - [Dòng 25](../Car_Dealership/src/java/utils/DBUtil.java#L25): `String password = "12345";`
  - [Dòng 27](../Car_Dealership/src/java/utils/DBUtil.java#L27): chuỗi kết nối DB hardcode trực tiếp
