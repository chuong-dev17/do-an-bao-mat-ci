<%-- 
    ...
    Created on : 28/02/2025, 5:53:37 AM
    Author     : Admin_Coder
--%>
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">${l.invoiceDate}</td>
                            <td class="text-center">${l.salesID}</td>
                            <td class="text-center">${l.carID}</td>
                            <td class="text-center">${l.custID}</td>
                            <td class="text-center">
                                <a href="invoiceDetails.jsp?id=${l.invoiceID}" class="btn btn-sm btn-details">
