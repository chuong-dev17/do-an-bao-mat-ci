...
public class UpdateProfileController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        CustomerDTO editedP = new CustomerDTO(custID, custName, phone, sex, cusAddress);
        dao.updateProfile(editedP);
        session.setAttribute("USER", editedP);
        request.setAttribute("success", "Update thành công, vui lòng nhấn f5 hoặc reload và đăng nhập ");
